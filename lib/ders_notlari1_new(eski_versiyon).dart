...
class DersNotlari1Old extends StatefulWidget { 
  const DersNotlari1Old({Key? key}) : super(key: key);

  @override
  _DersNotlari1OldState createState() => _DersNotlari1OldState();
}

class _DersNotlari1OldState extends State<DersNotlari1Old> {
